...
RegisterServerEvent('wl_manette:toglilemantte')
AddEventHandler('wl_manette:toglilemantte', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.removeInventoryItem(Config.ItemManette, 1)
end)

RegisterServerEvent('wl_manette:aggiungimantte')
AddEventHandler('wl_manette:aggiungimantte', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.addInventoryItem(Config.ItemManette, 1)
end)
